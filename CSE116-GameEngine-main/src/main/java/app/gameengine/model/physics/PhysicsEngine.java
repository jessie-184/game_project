...
public class PhysicsEngine {
    ...
    public void updateObject(DynamicGameObject dynamicObject, double dt){
        ...
        Vector2D currentLocation = dynamicObject.getLocation();
        Vector2D velocity = dynamicObject.getVelocity();
        currentLocation.setX(currentLocation.getX() + velocity.getX() * dt);
        currentLocation.setY(currentLocation.getY() + velocity.getY() * dt);
    }
